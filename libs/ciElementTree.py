...
if VERSION >= (3, 3):
    ...
    try:
        from _local_arch_py2.ciElementTree import *  # NOQA
        platform = "Local arch"
    except ImportError:
        if PLATFORM == 'darwin':
            from _macosx_universal_py26.ciElementTree import *  # NOQA
            platform = "MacOS X Universal"
        elif PLATFORM.startswith('linux'):
            if ARCH == 'x64':
                from _linux_libcpp6_x86_64_py26.ciElementTree import *  # NOQA
                platform = "Linux 64 bits"
            elif ARCH == 'x32':
                from _linux_libcpp6_x86_py26.ciElementTree import *  # NOQA
                platform = "Linux 32 bits"
        elif PLATFORM.startswith('win'):
            if ARCH == 'x64':
                from _win64_py26.ciElementTree import *  # NOQA
                platform = "Windows 64 bits"
            elif ARCH == 'x32':
                from _win32_py26.ciElementTree import *  # NOQA
